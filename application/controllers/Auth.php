...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert"><center>Email is not activated!</center></div>');
                redirect('auth');
            }
        } else {
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Pasien Registration';
            $this->load->view('templates/auth_header', $data);
    ...
    public function logout()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"><center>You have been logout</center></div>');
        redirect('auth');
    }
}
