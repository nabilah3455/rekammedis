        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" method="POST" action="<?= base_url('obat/update_kategori') ?>">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Kategori</label>
                                    <?php foreach ($items as $i) { ?>
                                        <input type="hidden" name="id" class="form-control" id="id" value="<?= $i['kode'] ?>">
                                        <input type="text" name="kategori" class="form-control" id="kategori" value="<?= $i['nama_kategori'] ?>">
