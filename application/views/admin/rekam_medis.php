                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?= base_url('admin/myprofile'); ?>" class="btn btn-default btn-flat">My Profile</a>
                            </div>
                ...
                <div class="row">
                            ...
                            <div class="box-header">
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <td width=5px>Tanggal</td>
                                                <td width=5px>Tensi</td>
                                                <td width=50px>Anamnese/ Diagnosa</td>
                                                <td width=5px>Terapi</td>
                                        ...
                                        <tbody>
                                            <?php foreach ($medis as $m) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $m['terapi'] ?></td>
                                                    <td>
                                                        <a href="<?= base_url('medis/edit_medis') ?>?id=<?= $m['id'] ?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <div class="box">
                                <div class="box-header">
                                    <form action="<?= base_url('medis/update_rekam_medis') ?>" method="post">
                                        <?php
                                        foreach ($get_id as $m) {
                                        ?>
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    ...
                                                    <a href="<?= base_url('medis/update_sesi') ?>?id=<?= $m['id'] ?>" class="btn btn-warning">Selesai</a>
                                                <?php } ?>
                                                </div>
                                            </div>
                                    </form>
...
<div>
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; Aplikasi Rekam Medis Klinik Rumah Sehat Eriadio <?= date('Y', $date); ?></>.</strong>
    </footer>
</div>
