                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="1%">Terapi</th>
                                                <th width="1%">Kartu Pasien</th>
                                                <!-- <td>Obat</td> -->
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $no = 1;
                                            foreach ($riwayat_berobat as $i) { ?>
                                                <tr>
                                                    <td><?= $no ?></td>
                                                    <td><?= $i['tanggal'] ?></td>
                                                    <td><?= $i['no_medis'] ?></td>
                                                    ...
                                                    <td><?= $i['diagnosa'] ?></td>
                                                    <td><?= $i['terapi'] ?></td>
                                                    <td><a href="<?= base_url('pasien/kartu_pasien') ?>?no_medis=<?= $i['no_medis'] ?>&&id=<?= $i['id'] ?>" class="btn btn-primary"><i class="glyphicon glyphicon-file"></i></a>
                                                    </td>
