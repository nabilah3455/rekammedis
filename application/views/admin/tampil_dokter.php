    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-lg-12">
                        <a href="<?= base_url('dokter/tambah_dokter') ?>" class="btn btn-primary">Tambah Data Dokter</a>
                        <div class="box">
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped" width='100%'>
                                        <thead>
                                            <tr>
                                                <td width=1px>No</td>
                                                <td width=10px>Kode Dokter</td>
                                                <td width=200px>Nama</td>
                                                <td width=5px>Jenis Kelamin</td>
                                                <td width=10px>Poli</td>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($items as $i) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $i['poli'] ?></td>
                                                    <td>
                                                        <a href="<?= base_url('dokter/edit_dokter') ?>?id=<?= $i['id'] ?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
