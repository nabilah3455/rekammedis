                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <td>No</td>
                                                <td width=10px>Kode Obat</td>
                                                <td width=90px>Nama Obat</td>
                                ...
                                <div class="box-header">
                                    ...
                                    <form action="<?= base_url('obat/tambah_obat') ?>" method="post">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" id="kode_obat" name="kode_obat" placeholder="Kode obat" value="<?= set_value('kode_obat') ?>">
                                            <?= form_error('kode_obat', '<small class="text-danger">', '</small>') ?>
                                        </div>
                                        <div class="form-group has-feedback">
                                            <label class="control-label">Nama Obat</label>
                                            <input type="text" class="form-control" id="nama_obat" name="nama_obat" placeholder="Nama obat" value="<?= set_value('nama_obat') ?>">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" id="stok" name="stok" placeholder="Jumlah" value="<?= set_value('stok') ?>">
