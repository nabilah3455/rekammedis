        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" method="POST" action="<?= base_url('dokter/update_dokter') ?>">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_dokter" value="<?= $i['kode_dokter'] ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jk">
                                            <option value="<?= $i['jk'] ?>"><?= $i['jenis_kelamin'] ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="poli" class="form-control" id="poli" name="poli" placeholder="poli" value="<?= $i['poli'] ?>" required>
                                    </div>
                                </div>
                            <?php
                            } ?>
